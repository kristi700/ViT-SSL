...
def test_ffn_output_shape(
    ffn_model: FeedForwardBlock, sample_input_tensor: torch.Tensor
):
    """
...
def test_ffn_batch_independence(
    ffn_model: FeedForwardBlock, sample_input_tensor: torch.Tensor
):
    """
    ...
    ), "Batch processing differs significantly from individual processing."
